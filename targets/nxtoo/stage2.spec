...
USE="-*" emerge -v1 --nodeps sys-apps/openrc
PYTHON_TARGETS="python2_7 python3_2" USE="-* build bootstrap" emerge portage || exit 1
...
pkglist = ["help2man","texinfo", "gettext", "binutils", "gcc", "glibc", "baselayout", "zlib", "shadow" ]
